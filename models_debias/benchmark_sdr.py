...
def train(model, propensity_model, baseline_model, train_loader, optimizer_prop, optimizer_imp, optimizer_reg, num_epochs, val_data, patience, args):
    ...
    This is a baseline adaptation of SDR to the PU setting (no mask used for training).
    """
...
def main():
    ...
    print("="*70)
    print("Stable Doubly Robust (SDR) Reward Modeling (PU setting: UNK->0, mask-invisible)")
    print("="*70)

...
def loss_codis(loss1, loss2, pred1, pred2, forget_rate, args):
    """
...
def train(net1, net2, train_loader, optimizer1, optimizer2, num_epochs, val_data, patience, args):
    ...
    for epoch in range(num_epochs):
        ...
        for batch_X, batch_y in bar:
            ...
            loss1, loss2 = loss_codis(loss1_raw, loss2_raw, reward_pred1, reward_pred2, rate_schedule[epoch], args)
...
def main():
    ...
    print("="*70)
    print("CoDis Reward Modeling (PU setting: UNK->0, mask-invisible)")
    print("="*70)

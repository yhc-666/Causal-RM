"""
Optuna hyperparameter tuning script for UPRL model.

Optimizes R2 on test with val-based early stopping.
Runs datasets in order: hs, saferlhf, ufb (configurable).

Usage:
    python scripts/optuna/tune_uprl.py
    python scripts/optuna/tune_uprl.py --datasets hs,saferlhf,ufb --n_trials 250
    python scripts/optuna/tune_uprl.py --alpha 0.2 --resume
"""
...
MODEL_NAME = "uprl"
SCRIPT_PATH = "models_pu/benchmark_uprl.py"
...
def _suggest_params(trial: optuna.Trial) -> dict:
    """Suggest hyperparameters for UPRL model."""
    return {

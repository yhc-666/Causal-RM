"""
Optuna hyperparameter tuning script for NCRMF model.

Optimizes R2 on test with val-based early stopping.
Runs datasets in order: hs, saferlhf, ufb (configurable).

Usage:
    python scripts/optuna/tune_ncrmf.py
    python scripts/optuna/tune_ncrmf.py --datasets hs,saferlhf,ufb --n_trials 300
    python scripts/optuna/tune_ncrmf.py --alpha 0.2 --resume
"""
...
MODEL_NAME = "ncrmf"
SCRIPT_PATH = "models_pu/benchmark_ncrmf.py"
...
def _suggest_params(trial: optuna.Trial) -> dict:
    """Suggest hyperparameters for NCRMF model."""
    return {

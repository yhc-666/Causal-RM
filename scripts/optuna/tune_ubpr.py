"""
Optuna hyperparameter tuning script for UBPR model.

Optimizes R2 on test with val-based early stopping.
Runs datasets in order: hs, saferlhf, ufb (configurable).

Usage:
    python scripts/optuna/tune_ubpr.py
    python scripts/optuna/tune_ubpr.py --datasets hs,saferlhf,ufb --n_trials 100
    python scripts/optuna/tune_ubpr.py --alpha 0.2 --resume
"""
...
MODEL_NAME = "ubpr"
SCRIPT_PATH = "models_pu/benchmark_ubpr.py"
...
def _suggest_params(trial: optuna.Trial) -> dict:
    """Suggest hyperparameters for UBPR model."""
    return {

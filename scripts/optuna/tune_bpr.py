"""
Optuna hyperparameter tuning script for BPR model.

Optimizes R2 on test with val-based early stopping.
Runs datasets in order: hs, saferlhf, ufb (configurable).

Usage:
    python scripts/optuna/tune_bpr.py
    python scripts/optuna/tune_bpr.py --datasets hs --n_trials 100
    python scripts/optuna/tune_bpr.py --alpha 0.2 --resume
"""
...
MODEL_NAME = "bpr"
SCRIPT_PATH = "models_pu/benchmark_bpr.py"
...
def _suggest_params(trial: optuna.Trial) -> dict:
    """Suggest hyperparameters for BPR model."""
    return {

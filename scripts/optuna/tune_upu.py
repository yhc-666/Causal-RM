"""
Optuna hyperparameter tuning script for UPU model.
...
Usage:
    python scripts/optuna/tune_upu.py
    python scripts/optuna/tune_upu.py --datasets hs,saferlhf,ufb --n_trials 250
    python scripts/optuna/tune_upu.py --alpha 0.2 --resume
"""
...
MODEL_NAME = "upu"
SCRIPT_PATH = "models_pu/benchmark_upu.py"
...
def _suggest_params(trial: optuna.Trial, data_name: str) -> dict:
    """Suggest hyperparameters for UPU model."""

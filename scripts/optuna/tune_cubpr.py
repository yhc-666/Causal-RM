"""
Optuna hyperparameter tuning script for CUBPR model.

Optimizes R2 on test with val-based early stopping.
Runs datasets in order: hs, saferlhf, ufb (configurable).

Usage:
    python scripts/optuna/tune_cubpr.py
    python scripts/optuna/tune_cubpr.py --datasets hs,saferlhf,ufb --n_trials 100
    python scripts/optuna/tune_cubpr.py --alpha 0.2 --resume
"""
...
MODEL_NAME = "cubpr"
SCRIPT_PATH = "models_pu/benchmark_cubpr.py"
...
def _suggest_params(trial: optuna.Trial) -> dict:
    """Suggest hyperparameters for CUBPR model."""
    return {
        ...
        "num_neg": int(trial.suggest_categorical("num_neg", [1, 2, 5, 10, 20])),

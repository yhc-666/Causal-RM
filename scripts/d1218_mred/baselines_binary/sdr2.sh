...
for _alpha in "${_alpha_list[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$gpu_allocation python -u benchmark_sdr2.py $CMD \
...
# _l2_prop_list=(1e-7 1e-6 5e-8)
# _l2_imp_list=(1e-7 1e-6 1e-5)
# _w_reg_list=(1.0 2 5)
...
# _hidden_dim_prop_list=("256,64")
# _seed_list=(42)
# _l2_reg_list=(1e-6 2e-6 5e-6 8e-7)
# _l2_prop_list=(1e-7 2e-7 8e-8 5e-7)
# _l2_imp_list=(8e-7 1e-6 2e-6 5e-6)
# _w_reg_list=(1.0 5 10)
# _w_prop_list=(0.5 0.2 0.1)
# _w_imp_list=(2 5 10)
# _eta_list=(1.0 1.5 2)
...
_hidden_dim_prop_list=("256,64")
_seed_list=(42)
_l2_reg_list=(1e-6 2e-6 8e-7)
_l2_prop_list=(1e-7 2e-7 8e-8)
_l2_imp_list=(8e-7 1e-6 2e-6)
_w_reg_list=(1.0 2 3 4)
_w_prop_list=(0.5 0.2 0.8)
_w_imp_list=(2 3 4)
_eta_list=(1.0 0.2 0.5)

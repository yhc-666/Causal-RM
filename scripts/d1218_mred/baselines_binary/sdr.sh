...
_seed_list=(42)
_l2_reg_list=(1e-7 1e-6)
_l2_prop_list=(1e-7 1e-6)
_l2_imp_list=(1e-7 1e-6)
_w_reg_list=(1.0 0.2 2)
_w_prop_list=(1.0 0.2 2)
_w_imp_list=(1.0 0.2 2)
_eta_list=(1.0)
...
for _l2_imp in "${_l2_imp_list[@]}"; do
...
for _alpha in "${_alpha_list[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$gpu_allocation python -u benchmark_sdr.py $CMD \
...
# _hidden_dim_prop_list=("256,64")
# _seed_list=(42)
# _l2_reg_list=(1e-7 1e-8 5e-8)
# _l2_prop_list=(1e-7 1e-8 5e-8)
# _l2_imp_list=(1e-7 1e-8 5e-8)
# _w_reg_list=(1.0 0.2 2 0.5)
# _w_prop_list=(1.0 0.2 2 0.5)
# _w_imp_list=(1.0 0.2 2 0.5)
# _eta_list=(1.0)
...
# _hidden_dim_prop_list=("256,64")
# _seed_list=(42)
# _l2_reg_list=(1e-7 1e-8 5e-8 2e-7 5e-9)
# _l2_prop_list=(1e-7 1e-8 5e-8 2e-7 5e-9)
# _l2_imp_list=(1e-7 1e-8 5e-8 2e-7 5e-9)
# _w_reg_list=(1.0 0.2 0.1)
# _w_prop_list=(1.0 0.2 0.1)
# _w_imp_list=(1.0 0.2 0.1)
# _eta_list=(1.0 0.5 2)
...
# _l2_reg_list=(1e-7 1e-8 5e-8)
# _l2_prop_list=(1e-7 1e-8 5e-8)
# _l2_imp_list=(1e-8 5e-8 5e-9)
# _w_reg_list=(1.0 0.2 0.5)
# _w_prop_list=(1.0 0.2 0.5)
# _w_imp_list=(1.0 0.2 0.5)
# _eta_list=(1.0 0.5)
...
# _hidden_dim_prop_list=("256,64")
# _seed_list=(42)
# _l2_reg_list=(1e-7 2e-7 5e-7)
# _l2_prop_list=(1e-7 2e-7 5e-7)
# _l2_imp_list=(1e-8 2e-8 5e-8)
# _w_reg_list=(1.0 0.2 0.1)
# _w_prop_list=(1.0 0.2 0.1)
# _w_imp_list=(1.0 0.2 0.1)
# _eta_list=(1.0 1.2 1.5)
...
_hidden_dim_prop_list=("256,64")
_seed_list=(42)
_l2_reg_list=(1e-7 8e-8 6e-8 2e-7)
_l2_prop_list=(1e-7 2e-7 8e-8 6e-8)
_l2_imp_list=(2e-8 6e-8 8e-8 1e-7)
_w_reg_list=(0.2 0.1 0.05)
_w_prop_list=(0.2 0.1 0.05)
_w_imp_list=(1.0 0.8 1.2)
_eta_list=(1.0 1.5 2 5)

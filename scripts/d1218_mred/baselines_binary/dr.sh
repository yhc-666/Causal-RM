...
# _l2_imp_list=(1e-7)
# _w_reg_list=(0.2)
# _w_prop_list=(1.0 0.2 2 0.5 1.2 1.5)
# _w_imp_list=(1.0 0.2 2 0.5 1.2 1.5)
...
for _alpha in "${_alpha_list[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=$gpu_allocation python -u benchmark_dr.py $CMD \

...
_w_reg_list=(1.0 0.2)
_w_prop_list=(1.0 0.2)
_w_noise_list=(1.0 0.2)
_w_imp_list=(1.0 0.2)
_quant_list=(0.97)
...
for _alpha in "${_alpha_list[@]}"; do
    ...
    CMD="--desc $desc --lr $_lr --batch_size $_batch_size --hidden_dim $_hidden_dim --l2_reg $_l2_reg --num_epochs $_num_epochs --patience $_patience --data_name $dst --alpha $_alpha --seed $_seed --monitor_on $_monitor_on --binary $_binary --r10 $_r10 --r01 $_r01 --w_reg $_w_reg --batch_size_prop $_batch_size_prop --hidden_dim_prop $_hidden_dim_prop --l2_prop $_l2_prop --w_prop $_w_prop --l2_noise $_l2_noise --w_noise $_w_noise --quant $_quant --l2_imp $_l2_imp --w_imp $_w_imp --batch_size_full $_batch_size_full"
    echo running $CMD
    ...
    CUDA_VISIBLE_DEVICES=$gpu_allocation python -u benchmark_ome_dr.py $CMD \
